...
var $author$project$Worker$outgoing = _Platform_outgoingPort(
	'outgoing',
	function ($) {
...
var $author$project$Worker$main = $elm$core$Platform$worker(
	{
		ax: function (flags) {
			return _Utils_Tuple2(
				0,
				$author$project$Worker$outgoing(
					{
						X: $elm$core$Maybe$Just(flags.E),
						ah: 'Ok'
					}));
		},
		aD: function (_v0) {
...
_Platform_export({'Worker':{'init':$author$project$Worker$main(
	A2(
		...
		A2($elm$json$Json$Decode$field, 'file', $elm$json$Json$Decode$string)))(0)}});}(this));